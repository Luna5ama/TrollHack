...
import dev.luna5ama.trollhack.mixins.accessor.render.AccessorDestroyBlockProgress
import dev.luna5ama.trollhack.mixins.accessor.render.AccessorRenderGlobal
import dev.luna5ama.trollhack.mixins.accessor.render.AccessorRenderManager
import dev.luna5ama.trollhack.mixins.accessor.render.AccessorShaderGroup
...
var RenderGlobal.renderEntitiesStartupCounter: Int
    ...
    set(value) {
        (this as AccessorRenderGlobal).trollSetRenderEntitiesStartupCounter(
            value
        )
    }
