package dev.luna5ama.trollhack.util.graphics.esp
...
import dev.luna5ama.trollhack.util.graphics.mask.BoxOutlineMask
import dev.luna5ama.trollhack.util.graphics.mask.BoxVertexMask
...
class DynamicBoxRenderer : AbstractIndexedRenderer() {
    ...
    inner class Builder {
        ...
        private fun buildIboBuffer(): ShortBuffer {
            val iboBuffer =
                GLAllocation.createDirectByteBuffer((filledIndexList.size + outlineIndexList.size) * 2).asShortBuffer()
    ...
    object Shader : DrawShader(
        "/assets/trollhack/shaders/general/DynamicBoxRenderer.vsh",
