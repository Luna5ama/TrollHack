...
internal object NoteBot : Module(
    ...
    private val noteBlockMap =
        EnumMap<NoteBlockEvent.Instrument, Array<BlockPos?>>(NoteBlockEvent.Instrument::class.java)
            ...
            for (x in -5..5) {
                for (y in -3..6) {
                    for (z in -5..5) {
                        ...
                        if (!world.isAir(pos.x, pos.y + 1, pos.z)) continue
