...
internal object Scaffold : Module(
    ...
    private val towerMotion by setting("Tower Motion", 0.42f, 0.0f..1.0f, 0.01f, { towerMode })
    private val towerJumpHeight by setting("Tower Jump Height", 0.3f, 0.0f..1.0f, 0.01f, { towerMode })
    private val towerPlaceHeight by setting("Tower Place Height", 1.1f, 0.0f..1.5f, 0.01f, { towerMode })
