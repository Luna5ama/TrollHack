...
internal object PacketLimiter : Module(
    ...
    private val maxPacketsLong by setting(
        "Max Packets Long", 22.0f, 10.0f..40.0f, 0.25f,
        description = "Maximum packets per second in long term"
    )
    private val longTermTicks by setting("Long Term Ticks", 100, 20..250, 5)
    private val maxPacketsShort by setting(
        "Max Packets Short", 25.0f, 10.0f..40.0f, 0.25f,
