...
import dev.luna5ama.trollhack.util.EntityUtils.mobTypeSettings
...
internal object Chams : Module(
    ...
    private val shadeMode0 = setting(
        "Shade Mode",
        ShadeMode.BOTH,
        page.atValue(Page.VISIBLE_RENDERING) and renderMode0.atValue(RenderMode.VISIBLE, RenderMode.BOTH)
    )
    private val shadeMode by shadeMode0
    private val texture by setting(
        "Texture",
        false,
        page.atValue(Page.VISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.VISIBLE,
            RenderMode.BOTH
        ) and shadeMode0.atValue(ShadeMode.FILLED, ShadeMode.BOTH)
    )
    private val lighting by setting(
        "Lighting",
        false,
        page.atValue(Page.VISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.VISIBLE,
    ...
    private val aOutline by setting(
        ...
        page.atValue(Page.VISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.VISIBLE,
            RenderMode.BOTH
        ) and shadeMode0.atValue(ShadeMode.OUTLINE, ShadeMode.BOTH)
    )
    private val width by setting(
        "Width",
        2.0f,
        1.0f..8.0f,
        0.1f,
    ...
    private val shadeModeInvisible0 = setting(
        "Shade Mode Invisible",
        ShadeMode.OUTLINE,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(RenderMode.INVISIBLE, RenderMode.BOTH)
    )
    private val shadeModeInvisible by shadeModeInvisible0
    private val textureInvisible by setting(
        "Texture Invisible",
        false,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.INVISIBLE,
            RenderMode.BOTH
        ) and shadeModeInvisible0.atValue(ShadeMode.FILLED, ShadeMode.BOTH)
    )
    private val lightingInvisible by setting(
        "Lighting Invisible",
        false,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.INVISIBLE,
    ...
    private val rainbowInvisible0 = setting(
        "Rainbow Invisible",
        false,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(RenderMode.INVISIBLE, RenderMode.BOTH)
    )
    private val rainbowInvisible by rainbowInvisible0
    private val colorInvisible by setting(
        "Color Invisible",
        ColorRGB(255, 255, 255),
        false,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(
    ...
    private val aFilledInvisible by setting(
        "Filled Alpha Invisible",
        127,
        0..255,
        1,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(
    ...
    private val aOutlineInvisible by setting(
        "Outline Alpha Invisible",
        255,
        0..255,
        1,
        page.atValue(Page.INVISIBLE_RENDERING) and renderMode0.atValue(
            RenderMode.INVISIBLE,
            RenderMode.BOTH
        ) and shadeModeInvisible0.atValue(ShadeMode.OUTLINE, ShadeMode.BOTH)
    )
    private val widthInvisible by setting(
        "Width Invisible",
        2.0f,
        1.0f..8.0f,
        0.1f,
