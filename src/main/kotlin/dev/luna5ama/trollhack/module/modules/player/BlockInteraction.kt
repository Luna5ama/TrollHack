...
import dev.luna5ama.trollhack.mixins.core.MixinMinecraft
import dev.luna5ama.trollhack.mixins.core.render.MixinEntityRenderer
import dev.luna5ama.trollhack.mixins.core.world.MixinBlockLiquid
import dev.luna5ama.trollhack.module.Category
import dev.luna5ama.trollhack.module.Module
import dev.luna5ama.trollhack.util.accessor.side
...
internal object BlockInteraction : Module(
    ...
    private val checkBlocks by setting(
        "Check Blocks",
        true,
        noEntityTrace0.atTrue(),
        description = "Only ignores entity when there is block behind"
    )
    private val anyItems0 = setting("Any Items", false, noEntityTrace0.atTrue())
    private val anyItems by anyItems0
    private val pickaxe0 = setting(
        "Pickaxe",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity when holding pickaxe"
    )
    private val pickaxe by pickaxe0
    private val gapple0 = setting(
        "Gapple",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity when holding gapple"
    )
    private val gapple by gapple0
    private val crystal0 = setting(
        "Crystal",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity when holding gapple"
    ...
    private val totem0 = setting(
        "Totem",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity when holding totem"
    )
    private val totem by totem0
    private val freecam by setting(
        "Freecam",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity in Freecam"
    )
    private val sneakOverrides by setting(
        "Sneak Override",
        true,
        noEntityTrace0.atTrue() and anyItems0.atFalse(),
        description = "Ignores entity when sneaking"
    )
