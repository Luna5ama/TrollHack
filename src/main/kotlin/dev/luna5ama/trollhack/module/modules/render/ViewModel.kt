...
internal object ViewModel : Module(
    ...
    private val posXR by setting(
        "Pos X Right",
        0.0f,
        -5.0f..5.0f,
        0.025f,
        page.atValue(Page.POSITION) and separatedHand0.atTrue()
    )
    private val posYR by setting(
        "Pos Y Right",
        0.0f,
        -5.0f..5.0f,
        0.025f,
    ...
    private val posXT by setting(
        "Pos X Totem",
        0.0f,
        -5.0f..5.0f,
        0.025f,
        page.atValue(Page.POSITION) and totem0.atTrue()
    )
    private val posYT by setting(
        "Pos Y Totem",
        0.0f,
        -5.0f..5.0f,
        0.025f,
    ...
    private val rotateXR by setting(
        "Rotate X Right",
        0.0f,
        -180.0f..180.0f,
        1.0f,
        page.atValue(Page.ROTATION) and separatedHand0.atTrue()
    )
    private val rotateYR by setting(
        "Rotate Y Right",
        0.0f,
        -180.0f..180.0f,
        1.0f,
    ...
    private val rotateZR by setting(
        "Rotate Z Right",
        0.0f,
        -180.0f..180.0f,
        1.0f,
    ...
    private val rotateXT by setting(
        "Rotate X Totem",
        0.0f,
        -180.0f..180.0f,
        1.0f,
        page.atValue(Page.ROTATION) and totem0.atTrue()
    )
    private val rotateYT by setting(
        "Rotate Y Totem",
        0.0f,
        -180.0f..180.0f,
        1.0f,
    ...
    private val rotateZT by setting(
        "Rotate Z Totem",
        0.0f,
        -180.0f..180.0f,
        1.0f,
    ...
    private val scaleR by setting(
        "Scale Right",
        1.0f,
        0.1f..3.0f,
        0.025f,
        page.atValue(Page.SCALE) and separatedHand0.atTrue()
    )
