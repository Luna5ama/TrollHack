...
object NoRender : Module("No Render", category = Category.RENDER) {
    ...
    val hurtCam by setting("Hurt Cam", true)
    val fireOverlay by setting("Fire Overlay", true)
    val waterOverlay by setting("Water Overlay", true)
    val blockOverlay by setting("Block Overlay", true)
    ...
    val fireEntity by setting("Entity Fire", true)
    ...
    val campFire by setting("Camp Fire", true)
