...
import dev.luna5ama.trollhack.command.args.*
import dev.luna5ama.trollhack.command.execute.ExecuteOption
...
open class CommandBuilder<E : IExecuteEvent>(
    ...
    protected inline fun AbstractArg<*>.literal(
        ...
        val arg = LiteralArg(name, alias.toSet())
        this.append(arg)
        arg.block()
    }
