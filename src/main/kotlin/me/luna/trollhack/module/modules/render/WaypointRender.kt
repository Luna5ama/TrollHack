...
import me.luna.trollhack.event.events.WaypointUpdateEvent
...
internal object WaypointRender : Module(
    ...
    private fun drawText(pos: BlockPos, textComponentIn: TextComponent, distance: Int) {
        ...
        RenderUtils2D.drawRectFilled(stringWidth * -0.5f - 4.0f, stringHeight * -0.5f - 4.0f, stringWidth * 0.5f + 4.0f, stringHeight * 0.5f + 4.0f, ColorRGB(32, 32, 32, 172))
        RenderUtils2D.drawRectOutline(stringWidth * -0.5f - 4.0f, stringHeight * -0.5f - 4.0f, stringWidth * 0.5f + 4.0f, stringHeight * 0.5f + 4.0f, 2f, ColorRGB(80, 80, 80, 232))
