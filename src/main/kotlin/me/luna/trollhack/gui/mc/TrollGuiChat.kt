package me.luna.trollhack.gui.mc
...
import me.luna.trollhack.command.args.GreedyStringArg
import me.luna.trollhack.module.modules.client.GuiSetting
import me.luna.trollhack.util.accessor.historyBuffer
import me.luna.trollhack.util.accessor.sentHistoryCursor
...
class TrollGuiChat(
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils2D.drawRectOutline(inputField.x - 2.0f, inputField.y - 2.0f, inputField.x - 2.0f + inputField.width, inputField.y - 2.0f + inputField.height, 1.0f, GuiSetting.primary)
    }
