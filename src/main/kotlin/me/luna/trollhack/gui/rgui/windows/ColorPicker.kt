...
import me.luna.trollhack.gui.rgui.component.Button
import me.luna.trollhack.gui.rgui.component.SettingSlider
import me.luna.trollhack.gui.rgui.component.Slider
...
object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f, SettingGroup.NONE) {
    ...
    private fun drawColorField() {
        ...
        // Outline
        RenderUtils2D.drawRectOutline(fieldPos.first.x, fieldPos.first.y, fieldPos.second.x, fieldPos.second.y, 1.5f, GuiSetting.outline)
    ...
    private fun drawHueSlider() {
        ...
        // Outline
        RenderUtils2D.drawRectOutline(huePos.first.x, huePos.first.y, huePos.second.x, huePos.second.y, 1.5f, GuiSetting.outline)
    ...
    private fun drawColorPreview() {
        ...
        RenderUtils2D.drawRectOutline(prevColorPos.first.x, prevColorPos.first.y, prevColorPos.second.x, prevColorPos.second.y, 1.5f, GuiSetting.outline)
        ...
        RenderUtils2D.drawRectOutline(currentColorPos.first.x, currentColorPos.first.y, currentColorPos.second.x, currentColorPos.second.y, 1.5f, GuiSetting.outline)
