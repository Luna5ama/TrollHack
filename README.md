...
- Are you on the very latest version? In this case, it should be 1.0.0
- Did you compile it yourself, or did you use the release?
- Are your graphics drivers up to date?
- Are you using fast render? (If your version is below 1.0.0, you must upgrade to fix the fast render crash)  
